  ...
  return (
    <div>
      <Div>
        ...
        <Down>
          <Card2 title='Page Views' pic={fb} icon={up} rate='85%' count='570'/>
          <Card2 title='Views' pic={yt} icon={down} rate='24%' count='14'/>
          <Card2 title='Likes' icon={up} pic={tw} rate='75%' count='600'/>
          <Card2 title='Likes' icon={up} pic={fb} rate='65%' count='9451'/>
        </Down>
        <Down2>
          <Card2 title='Likes' icon={up} pic={insta} rate='92%' count='2211'/>
          <Card2 title='Subscribers' icon={up} pic={yt} rate='75%' count='4351'/>
          <Card2 title='Retweet' icon={down} pic={tw} rate='15%' count='21'/>
          <Card2 title='Profile Viewers' icon={down} pic={insta} rate='5%' count='12'/>
        </Down2>
      </Div>
    </div>
  )
